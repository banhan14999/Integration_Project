        ...
        if($_POST['total_type'] === "Shareholder_Status"){
            ...
            while($rows =  sqlsrv_fetch_array($sql_select)){
                ...
                if(array_key_exists($ethnicity,$ethnicities)){
                    $ethnicities[$ethnicity] = $ethnicities[$ethnicity] + $mysql_select['Paid Last Year'];
                }
                else{
                    $ethnicities[$ethnicity] = $mysql_select['Paid Last Year'];
                }
            }
            //Lấy hết key
            ...
            while($rows =  sqlsrv_fetch_array($sql_select)){
                ...
                if(array_key_exists($employee,$employees)){
                    $employees[$employee] = $employees[$employee] + $mysql_select['Paid Last Year'];
                }
                else{
                    $employees[$employee] = $mysql_select['Paid Last Year'];
                }
            }
            //Lấy hết key
